...
public class HomeController : Controller
{
    ...
    public IActionResult Generar(string palo, string numero, string palo1, string numero1, string palo2, string numero2, string palo3, string numero3, string palo4, string numero4)
    {
        ...
        {
            new Carta
            {   Palo = palo, Numero = int.Parse(numero),
            },
            new Carta
            {  Palo = palo1,  Numero = int.Parse(numero1),
            },
            new Carta
            {  Palo = palo2, Numero = int.Parse(numero2),
            },
            new Carta
            {  Palo = palo3, Numero = int.Parse(numero3),
            },
            new Carta
            {  Palo = palo4, Numero = int.Parse(numero4),
            },
        };
